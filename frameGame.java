...
public class frameGame extends JFrame implements ActionListener, KeyListener{
	...
	public frameGame(String name, int width, int height) {
		...
		//this doesn't work, problem with image icon
		Hero hero1= new Hero (15,15);
		HeroIcon= new ImageIcon(getClass().getResource("avatar.jpg"));
        	HeroLabel= new JLabel(HeroIcon);
       		HeroLabel.setSize(20,20);
		HeroLabel.setLocation(hero1.getX(),hero1.getY());
